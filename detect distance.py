...
if __name__=="__main__":
    ...
    while True:
        ...
        cv2.imshow("Color frame1", color_frame)
        k = cv2.waitKey(1)
        
        if(k == ord("s")):
            img_path1 = r"E:\Project_Work\2025\Saffron_Project\Github_Code\Saffron_Image_Capture_Code\image\Color_Frame\frame_{}.jpg".format(counter)
            ...
            f = open(r"E:\Project_Work\2025\Saffron_Project\Github_Code\Saffron_Image_Capture_Code\image\Depth_Frame\frame_{}.txt".format(counter), "a+")
            np.savetxt(r"E:\Project_Work\2025\Saffron_Project\Github_Code\Saffron_Image_Capture_Code\image\Depth_Frame\frame_{}.txt".format(counter),depth_frame)
